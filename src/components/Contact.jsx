  ...
  return (
    <div>
      <section
        name="contact"
        id="contact"
        className="bg-[#F7F9FC] dark:bg-gray-900 py-16"
      >
        <div className="container bg-white/60 dark:bg-gray-800/60 mx-auto md:max-w-3xl px-6 border border-gray-200 dark:border-white/30 p-6 shadow-2xl rounded-lg">
